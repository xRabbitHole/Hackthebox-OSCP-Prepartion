...
![](../zzz\_rev/attachments/friendzone.png)

Visitando la pagina web possiamo vedere che l'e-mail è info@friendzoneportal.red. Il friendzoneportal.red potrebbe essere un possibile nome di dominio. Lo terremo a mente durante l'enumerazione dei DNS. Visualizziamo il codice sorgente per vedere se riusciamo a trovare altre informazioni. ma non c'è nulla di nuovo
...
![](../zzz\_rev/attachments/friendzone1.png)
...
![](../zzz\_rev/attachments/1sc42Qfcz0hRKipeM3sV1Mw.webp) Come possiamo vedere dice c'è l'immagine di deafult è al seguente indirizzo

```bash
?image_id=a.jpg&pagename=timestamp
```

![](../zzz\_rev/attachments/1N\_ShhPTERcBEUHo5Tj8iEg.webp)
...
![](../zzz\_rev/attachments/1pDOjwlUQ3\_JF\_xKFEre1ug.webp)
